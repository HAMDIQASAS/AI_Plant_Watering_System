...
Current soil moisture level from 0 to 100

moisture / 100

Last watered

Hours since the plant was last watered, from 0 to 48

lastWatered / 48

Plant type

Cactus = 0, Flower = 1, Herb = 2
...
Train the perceptron with live SSE updates

/train

POST

Train the perceptron and return JSON results

/predict

GET

Predict whether a plant needs water

/sa-stream

POST

Run simulated annealing with live SSE updates

/sa

POST

Run simulated annealing and return JSON results
